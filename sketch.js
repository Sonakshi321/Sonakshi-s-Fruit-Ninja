...
function setup(){
  ...
  sword = createSprite(length-50,200,20,20);
...
function fruits(){
  ...
  if(World.frameCount%80 ===0){
   ...
   fruit = createSprite(length-10,200,20,20);
    ...
    fruit.y=Math.round(random(40,370));
...
if(World.frameCount%200 ===0){
  ...
  monster = createSprite(windowWidth-10,200,20,20);
  
  monster.addAnimation("moving",monsterImage);
  
  monster.y=Math.round(random(40,370));
